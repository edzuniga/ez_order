...
class UpdateGastoCajaModal extends ConsumerStatefulWidget {
  const UpdateGastoCajaModal({required this.registroCaja, super.key});

  final RegistroCajaModelo registroCaja;

  @override
  ConsumerState<UpdateGastoCajaModal> createState() =>
      _DeleteMenuItemModalState();
}

class _DeleteMenuItemModalState extends ConsumerState<UpdateGastoCajaModal> {
  ...
  Future<void> _getDatos() async {
    _cantidad.text = widget.registroCaja.egreso.toString();
    _proveedor.text = widget.registroCaja.proveedor.toString();
    _descripcion.text = widget.registroCaja.descripcion.toString();
  }
          ...
          : SingleChildScrollView(
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Actualizar registro de gasto de CAJA',
                      style: TextStyle(
                        fontSize: 16,
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            await _tryActualizarGasto(registroCaja);
                          },
                          style: ElevatedButton.styleFrom(
  ...
  Future<void> _tryActualizarGasto(RegistroCajaModelo registroCaja) async {
    if (_gastoCajaKey.currentState!.validate()) {
      ...
      await supabaseClient.actualizarGastoCaja(registroCaja).then((message) {
        ...
        if (message == 'success') {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
            ...
            content: Text(
              'Ocurrió un error al intentar actualizar el registro -> $message',
