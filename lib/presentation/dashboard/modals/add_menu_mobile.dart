...
class AgregarMenuMobileModal extends ConsumerStatefulWidget {
  const AgregarMenuMobileModal({super.key});

  @override
  ConsumerState<AgregarMenuMobileModal> createState() =>
      _AgregarMenuMobileModalState();
}

class _AgregarMenuMobileModalState
    extends ConsumerState<AgregarMenuMobileModal> {
