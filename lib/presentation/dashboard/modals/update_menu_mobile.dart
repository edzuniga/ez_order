...
class UpdateMenuMobileModal extends ConsumerStatefulWidget {
  const UpdateMenuMobileModal({required this.itemMenu, super.key});
  final MenuItemModel itemMenu;

  @override
  ConsumerState<UpdateMenuMobileModal> createState() =>
      _UpdateMenuMobileModalState();
}

class _UpdateMenuMobileModalState extends ConsumerState<UpdateMenuMobileModal> {
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onChanged: (v) {
                                      if (v == '' || v.isEmpty) {
                                        _precioConIsvController.text = '0.00';
                                      } else {
